...
declare -Ar PACKAGES_BY_STAGE=(
  [0]="hexagonrpc libssc linux-firmware-sheng linux-xiaomi-sheng"
  [1]="iio-sensor-proxy"
  [2]="xiaomi-sheng-sensors"
...
declare -Ar PACKAGE_BUILD_DEPS=(
  ...
  [xiaomi-sheng-keyboard-helper]="hexagonrpc"
...
readonly PROJECT_PACKAGES
unset _stage _stage_packages
